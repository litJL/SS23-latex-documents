...
\begin{description}[leftmargin=5em, style=sameline]
	...
	\begin{lhp}{lb}{LB}{beschr:anwendungsbereich}
		...
		\item [Motivation:] Ein öffentlicher Release ist aus rechtlichen und zeitlichen Gründen nicht möglich. % CUSTOM LINE
		\item [Erfüllungskriterium:] Verteilung der Software in privaten Kreisen. % CUSTOM LINE
	\end{lhp}
	...
	\begin{lhp}{lb}{LB}{beschr:implsprache}
		...
		\item [Erfüllungskriterium:] Ausschließliches Verwenden von Java 8 oder höher. % CUSTOM LINE
	\end{lhp}
	...
	\begin{lhp}{lb}{LB}{beschr:gui}
		...
		\item [Motivation:] Das optimiert die Betreuung vom SEP und koordiniert die Mitarbeit.
		\item [Erfüllungskriterium:] Ausschließliches Verwenden von JavaFX zur GUI Programmierung. % CUSTOM LINE
	\end{lhp}
	...
	\begin{lhp}{lb}{LB}{beschr:gitlab}
		...
		\item [Motivation:] Das optimiert die Betreuung vom SEP und koordiniert die Mitarbeit.
		\item [Erfüllungskriterium:] Entwickeln des Projekts auf dem vorgegebenen GitLab-Repository. % CUSTOM LINE
	\end{lhp}
