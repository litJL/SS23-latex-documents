...
\begin{description}[leftmargin=5em, style=sameline]
	...
	\begin{lhp}{ld}{LD}{daten:kindersicherung}
		\item [Name:] Kindersicherung*
		\item [Fachliche Beschreibung:] Beschreibt, ob der Spieler account durch eine Kindersicherung geschützt ist.
		\item [Relevante Systemfunktionen:] \ref{funk:zugriff}
	\end{lhp}
\end{description}