...
\begin{description}[leftmargin=5em, style=sameline]	
	...
	% CUSTOM LINE
	\begin{lhp}{wr}{WR}{nfunk:sarch1}
		\item [Name:] Soundeffekte
		\item [Beschreibung:] Soundeffekte, die mit Spielaktionen synchronisiert sind
		\item [Motivation:] Höhere Zufriedenheit der Benutzer und immersion in die Spielwelt.
		\item [Erfüllungskriterium:] Soundeffekte für die meisten Kernaktionen die ein Spieler treffen kann.
	\end{lhp}
\end{description}